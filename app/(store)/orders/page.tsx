...
export const metadata: Metadata = {
  title: "Orders",
  description: "Store Frontend - Orders",
};
...
export default async function OrdersPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <section className="bg-white p-4 sm:p-8 rounded-xl shadow-lg w-full max-w-4xl">
        ...
        {orders.length === 0 ? (
          <article className="text-center text-gray-600">
            <p>You have no placed any orders yet.</p>
          </article>
        ) : (
                      ...
                      >
                        <div className="flex items-center gap-3 sm:gap-4">
                          {product.product?.image && (
                            <div className="relative size-14 sm:h-16 flex-shrink-0 rounded-md overflow-hidden">
                              <Image
